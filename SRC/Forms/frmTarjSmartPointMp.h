...
namespace pos {
	...
	/// <summary>
	/// Summary for frmTarjSmartPointMp
	///
	...
	/// </summary>
	public ref class frmTarjSmartPointMp : public Controles::BaseDialog
	{
	public:
		frmTarjSmartPointMp(Decimal ptotal)
		{
			struct mpag_ *p;
			InitializeComponent();
			//
			...
			actuTarjVerifonePrisma = gcnew TransSmartPointMp();
			...
			this->txtMonto->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &frmTarjSmartPointMp::txtMonto_KeyPress);			
			this->txtExtracash->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &frmTarjSmartPointMp::txtMonto_KeyPress);			

			this->txtCuotas->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &frmTarjSmartPointMp::txtSoloNumeros_KeyPress);			
			this->txtMonto->GotFocus += gcnew System::EventHandler(this, &frmTarjSmartPointMp::TbGotFocus);
			this->txtCuotas->GotFocus += gcnew System::EventHandler(this, &frmTarjSmartPointMp::TbGotFocus);			
			this->txtExtracash->GotFocus += gcnew System::EventHandler(this, &frmTarjSmartPointMp::TbGotFocus);			
	...
	protected:
		...
		TransSmartPointMp^ actuTarjVerifonePrisma;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// Titulo
			// 
			this->Titulo->Size = System::Drawing::Size(293, 23);
			this->Titulo->Text = L"Autoriza Tarjetas Smart Point";
			// 
			// btnDot
			// 
			...
			this->btnDot->TabIndex = 64;
			this->btnDot->Text = L".";
			this->btnDot->UseVisualStyleBackColor = false;
			this->btnDot->Click += gcnew System::EventHandler(this, &frmTarjSmartPointMp::btnDot_Click);
			// 
			// lblFaltante
			// 
			...
			this->txtExtracash->Font = (gcnew System::Drawing::Font(L"Tahoma", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->txtExtracash->Location = System::Drawing::Point(175, 289);
			this->txtExtracash->MaxLength = 10;
			this->txtExtracash->Name = L"txtExtracash";
			this->txtExtracash->Size = System::Drawing::Size(125, 26);
			this->txtExtracash->TabIndex = 77;
			this->txtExtracash->TextAlign = System::Windows::Forms::HorizontalAlignment::Right;
			this->txtExtracash->Visible = false;
			this->txtExtracash->TextChanged += gcnew System::EventHandler(this, &frmTarjSmartPointMp::txtCuotas_TextChanged);
			// 
			// label3
			// 
			this->label3->Font = (gcnew System::Drawing::Font(L"Tahoma", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(38, 291);
			...
			this->txtCuotas->Font = (gcnew System::Drawing::Font(L"Tahoma", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->txtCuotas->Location = System::Drawing::Point(176, 257);
			this->txtCuotas->MaxLength = 2;
			this->txtCuotas->Name = L"txtCuotas";
			this->txtCuotas->Size = System::Drawing::Size(46, 26);
			this->txtCuotas->TabIndex = 68;
			this->txtCuotas->TextAlign = System::Windows::Forms::HorizontalAlignment::Right;
			this->txtCuotas->TextChanged += gcnew System::EventHandler(this, &frmTarjSmartPointMp::txtCuotas_TextChanged);
			// 
			// lblRecargo
			// 
			this->lblRecargo->Font = (gcnew System::Drawing::Font(L"Tahoma", 8.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->lblRecargo->Location = System::Drawing::Point(306, 261);
			this->lblRecargo->Name = L"lblRecargo";
			this->lblRecargo->Size = System::Drawing::Size(87, 19);
			this->lblRecargo->TabIndex = 75;
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Tahoma", 8.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(233, 261);
			...
			this->lblCuotas->Font = (gcnew System::Drawing::Font(L"Tahoma", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->lblCuotas->Location = System::Drawing::Point(39, 259);
			this->lblCuotas->Name = L"lblCuotas";
			this->lblCuotas->Size = System::Drawing::Size(125, 19);
			this->lblCuotas->TabIndex = 66;
			...
			this->lblMonto->Location = System::Drawing::Point(45, 225);
			...
			this->cboTarjetas->Location = System::Drawing::Point(176, 188);
			this->cboTarjetas->Name = L"cboTarjetas";
			this->cboTarjetas->Size = System::Drawing::Size(191, 26);
			this->cboTarjetas->Sorted = true;
			this->cboTarjetas->TabIndex = 72;
			this->cboTarjetas->SelectedIndexChanged += gcnew System::EventHandler(this, &frmTarjSmartPointMp::cboTarjetas_SelectedIndexChanged);
			this->cboTarjetas->PreviewKeyDown += gcnew System::Windows::Forms::PreviewKeyDownEventHandler(this, &frmTarjSmartPointMp::cboTarjetas_PreviewKeyDown);
			// 
			// txtMonto
			// 
			this->txtMonto->Font = (gcnew System::Drawing::Font(L"Tahoma", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->txtMonto->Location = System::Drawing::Point(176, 223);
			...
			this->txtMonto->TextChanged += gcnew System::EventHandler(this, &frmTarjSmartPointMp::txtCuotas_TextChanged);
			// 
			// lvw
			// 
			...
			this->lvw->Location = System::Drawing::Point(33, 371);
			this->lvw->MultiSelect = false;
			this->lvw->Name = L"lvw";
			this->lvw->Size = System::Drawing::Size(424, 118);
			this->lvw->TabIndex = 70;
			this->lvw->UseCompatibleStateImageBehavior = false;
			this->lvw->View = System::Windows::Forms::View::Details;
			this->lvw->SelectedIndexChanged += gcnew System::EventHandler(this, &frmTarjSmartPointMp::lvw_SelectedIndexChanged);
			// 
			// clh1
			// 
			...
			this->btnAdd->Font = (gcnew System::Drawing::Font(L"Tahoma", 20.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->btnAdd->Location = System::Drawing::Point(388, 187);
			...
			this->tmrMensaje->Tick += gcnew System::EventHandler(this, &frmTarjSmartPointMp::tmrMensaje_Tick);
			// 
			// tmrFinalizar
			// 
			this->tmrFinalizar->Interval = 500;
			this->tmrFinalizar->Tick += gcnew System::EventHandler(this, &frmTarjSmartPointMp::tmrFinalizar_Tick);
			// 
			// frmTarjSmartPointMp
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(0)), static_cast<System::Int32>(static_cast<System::Byte>(94)), 
				static_cast<System::Int32>(static_cast<System::Byte>(136)));
			this->ClientSize = System::Drawing::Size(648, 567);
			this->Name = L"frmTarjSmartPointMp";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"frmTarjSmartPointMp";
			this->TopMost = false;
...
#pragma endregion
		...
		private: System::Void btnAdd_Click(System::Object^  sender, System::EventArgs^  e) 
			 {
				 ...
				 if (lmensaje == "<none>")
				 {
					 if (Dump::TarjSmartPointMp->Count <= CantTotalTarjetas){
						 ShowTarjeta^ mdatos = (ShowTarjeta^) cboTarjetas->SelectedItem;
						 if (!String::IsNullOrEmpty(mdatos->CodTarjetaPrisma))
						 {
							 OrdenCaja ^orc = gcnew OrdenCaja();
							 orc->Tienda = gcnew String(saptienda);
							 orc->Caja = caja;
							 orc->Cajero = ckaNro;
							 orc->Monto = actuTarjVerifonePrisma->Importe;
							 orc->Cuotas = actuTarjVerifonePrisma->AlbNumCuota;
							 orc->NroTicket = pf->GetTickNro(GlobalTF);
							 orc->AlbCodTarjeta = actuTarjVerifonePrisma->AlbNroTarjeta;
							 orc->PtoVta = System::Convert::ToInt32(gcnew String(pf->ptovta));
							 if (mdatos->CodTarjetaPrisma == "QRQ")
								 orc->TipoTarjeta = "qr";
							 else if (mdatos->TipoTarje == 'C')
								 orc->TipoTarjeta = "credit_card";
							 else
								 orc->TipoTarjeta = "debit_card";

							 MsgAlertSmartPointMp ^msaSmart = gcnew MsgAlertSmartPointMp(orc);
							 msaSmart->ShowMsgProcesaVenta("Creando Orden", "en Smart Point");
							 try{
								 RtaOrdenCaja ^rtaAprob = msaSmart->RespuestaVenta;
								 if (!msaSmart->ConError){
									 //action_required
									 if (rtaAprob->Estado == 6){

									 }
									 if (rtaAprob->Estado == 3)
									 {
										 actuTarjVerifonePrisma->ExternalReference = rtaAprob->ExternalReference;
										 actuTarjVerifonePrisma->IdOrdenMercadoPago = rtaAprob->IdOrdenMercadoPago;
										 actuTarjVerifonePrisma->IdPayment = rtaAprob->Reference; //rtaAprob->IdOperacion;
										 ...
										 Dump::TarjSmartPointMp->Add(actuTarjVerifonePrisma);								  
										 actuTarjVerifonePrisma = gcnew TransSmartPointMp();
										 lblFaltante->Text = "Faltan $: " + this->faltante.ToString("F2");
										 LlenarLvw();
										 NuevoCupon();		
									 ...
									 MessageBox::Show(msaSmart->MensajeError);
	 ...
	 private: System::Void LlenarLvw(System::Void)
			  {
					...
					for each (TransSmartPointMp ^tagposnet in Dump::TarjSmartPointMp)
					{						
						ListViewItem ^litem = gcnew ListViewItem();
						litem->Text = tagposnet->IdPayment;
	...
	protected: void virtual bEnter_Click(Object ^sender, EventArgs ^e) override
	   ...
	   protected: virtual void Cancel_Click(Object ^sender, EventArgs ^e) override
        {
            WriteBootLog("AVISO - Saliendo a pantalla de Cupones SMARTPOINT con CANCEL");			
        }
			...
			protected: virtual void btOk_Click(Object ^sender, EventArgs ^e) override
					   {
						   ...
						   WriteBootLog("AVISO - Saliendo a pantalla de Cupones SMARTPOINT con OK");
