...
static NN_DIGIT NN_AddDigitMult(NN_DIGIT *, NN_DIGIT *, NN_DIGIT, NN_DIGIT *, UINT);   
static NN_DIGIT NN_SubDigitMult(NN_DIGIT *, NN_DIGIT *, NN_DIGIT, NN_DIGIT *, UINT);   
   
static UINT NN_DigitBits(NN_DIGIT);   
...
/* Returns the significant length of a in bits.  
   ...
   Lengths: a[digits].  
 */   
UINT NN_Bits (NN_DIGIT *a, UINT digits)   
{   
...
/* Returns the significant length of a in digits.  
   ...
   Lengths: a[digits].  
 */   
UINT NN_Digits (NN_DIGIT *a, UINT digits)   
{   
  INT i;   
 ...
 */   
static UINT NN_DigitBits (NN_DIGIT a)   
{   
  UINT i;   
