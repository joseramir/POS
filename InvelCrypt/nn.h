...
#ifndef _NN_INCLUDED__
#define _NN_INCLUDED__
...
#define DIGIT_MSB(x) (UINT)(((x) >> (NN_DIGIT_BITS - 1)) & 1) 
#define DIGIT_2MSB(x) (UINT)(((x) >> (NN_DIGIT_BITS - 2)) & 3) 
 ...
 */ 
void NN_Decode(NN_DIGIT *, UINT, UCHAR *, UINT); 
void NN_Encode(UCHAR *, UINT, NN_DIGIT *, UINT); 
 
void NN_Assign(NN_DIGIT *, NN_DIGIT *, UINT); 
void NN_AssignZero(NN_DIGIT *, UINT); 
void NN_Assign2Exp(NN_DIGIT *, UINT, UINT); 
 
NN_DIGIT NN_Add(NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT); 
NN_DIGIT NN_Sub(NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT); 
void NN_Mult(NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT); 
void NN_Div(NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT, NN_DIGIT *, UINT); 
NN_DIGIT NN_LShift(NN_DIGIT *, NN_DIGIT *, UINT, UINT); 
NN_DIGIT NN_RShift(NN_DIGIT *, NN_DIGIT *, UINT, UINT); 
 
void NN_Mod(NN_DIGIT *, NN_DIGIT *, UINT, NN_DIGIT *, UINT); 
void NN_ModMult(NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT); 
void NN_ModExp(NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT, NN_DIGIT *, UINT); 
void NN_ModInv(NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT); 
void NN_Gcd(NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT); 
 
INT NN_Cmp(NN_DIGIT *, NN_DIGIT *, UINT); 
INT NN_Zero(NN_DIGIT *, UINT); 
UINT NN_Bits(NN_DIGIT *, UINT); 
UINT NN_Digits(NN_DIGIT *, UINT); 
