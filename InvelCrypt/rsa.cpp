...
static INT RSAPublicBlock(UCHAR *, UINT *, UCHAR *, UINT, R_RSA_PUBLIC_KEY *);   
static INT RSAPrivateBlock(UCHAR *, UINT *, UCHAR *, UINT, R_RSA_PRIVATE_KEY *);
   
/* RSA public-key encryption, according to PKCS #1.  
 */   
INT RSAPublicEncrypt(UCHAR *output, UINT *outputLen, 
 ...
 */   
INT RSAPublicDecrypt(UCHAR *output, UINT *outputLen, 
					 UCHAR *input, UINT inputLen, 
					 R_RSA_PUBLIC_KEY *publicKey)   
{   
  INT status;   
  UCHAR pkcsBlock[MAX_RSA_MODULUS_LEN];   
  UINT i, modulusLen, pkcsBlockLen;   
 ...
 */   
INT RSAPrivateEncrypt (UCHAR *output, UINT *outputLen, 
					   UCHAR *input, UINT inputLen, 
 ...
 */   
INT RSAPrivateDecrypt (UCHAR *output, UINT *outputLen,
					   UCHAR *input, UINT inputLen, 
					   R_RSA_PRIVATE_KEY *privateKey)   
{   
  INT status;   
 ...
 */   
static INT RSAPublicBlock (UCHAR *output, UINT *outputLen, 
						   UCHAR *input, UINT inputLen, 
						   R_RSA_PUBLIC_KEY *publicKey)   
{   
...
/* Raw RSA private-key operation. Output has same length as modulus.  
   ...
   Requires input < modulus.  
 */   
static INT RSAPrivateBlock (UCHAR *output, UINT *outputLen, 
							UCHAR *input, UINT inputLen, 
							R_RSA_PRIVATE_KEY *privateKey)   
{   
