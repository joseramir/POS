...
namespace pos {
	...
	/// </summary>
	public ref class Buscador : public System::Windows::Forms::Form, Controles::IBuscador
	{
	...
	private: System::Windows::Forms::ColumnHeader^  clhUnit1;
	private: System::Windows::Forms::ColumnHeader^  clhUnit2;
	public: System::Windows::Forms::Panel^  pnlOfertas;

	private: System::Windows::Forms::Label^  label2;



			 bool completarScanner;
	
	public:

		property DbfBrowse ^Browser;

		property bool OnlyNumeric;

		property String ^ActiveOrder
		{
			String ^get() { return activeOrder; }
			void set(String ^nval)
			{
				activeOrder = nval;
				completarScanner = (activeOrder == "mscansc");
			}
		}

		property int Completar;

		property wchar_t CompletarCon;

		Buscador(String ^order)
		{
			InitializeComponent();
			...
			seeking = false;
			saltear = 0;
			completarScanner = false;
			this->pnlOfertas->Visible = modoMayor >= 1;
			/*if (modoMayor == 2){
				label3->Visible = false;
				this->lvwBulto->Visible = false;
			}*/
			Grid->CellClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &Buscador::ClickCelda);
			mostrandolvw = false;
			//this->Grid->CellClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &Buscador::Grid_CellClick);
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Buscador::typeid));
			this->Grid = (gcnew System::Windows::Forms::DataGridView());
			this->Column1 = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			this->panel = (gcnew System::Windows::Forms::Panel());
			this->pnlOfertas = (gcnew System::Windows::Forms::Panel());
			this->label2 = (gcnew System::Windows::Forms::Label());
			this->lvwUnits = (gcnew System::Windows::Forms::ListView());
			this->clhUnit1 = (gcnew System::Windows::Forms::ColumnHeader());
			this->clhUnit2 = (gcnew System::Windows::Forms::ColumnHeader());
			...
			this->Grid->Location = System::Drawing::Point(4, 78);
			...
			// panel
			// 
			this->panel->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(255)), static_cast<System::Int32>(static_cast<System::Byte>(192)), 
				static_cast<System::Int32>(static_cast<System::Byte>(128)));
			this->panel->BorderStyle = System::Windows::Forms::BorderStyle::FixedSingle;
			this->panel->Controls->Add(this->pnlOfertas);
			this->panel->Controls->Add(this->pictureBox1);
			this->panel->Controls->Add(this->lbTit);
			...
			this->panel->Controls->Add(this->tbAyuda);
			this->panel->Controls->Add(this->label1);
			this->panel->Controls->Add(this->cancelar);
			this->panel->Controls->Add(this->ok);
			this->panel->Controls->Add(this->pagArriba);
			this->panel->Controls->Add(this->pagAbajo);
			this->panel->Controls->Add(this->filaAbajo);
			this->panel->Controls->Add(this->filaArriba);
			this->panel->Controls->Add(this->b3);
			this->panel->Controls->Add(this->b6);
			this->panel->Controls->Add(this->b9);
			this->panel->Controls->Add(this->bbksp);
			...
			this->panel->Font = (gcnew System::Drawing::Font(L"Tahoma", 8.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->panel->Location = System::Drawing::Point(0, 0);
			this->panel->Name = L"panel";
			this->panel->Size = System::Drawing::Size(800, 600);
			this->panel->TabIndex = 1;
			this->panel->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &Buscador::panel_Paint);
			// 
			// pnlOfertas
			// 
			this->pnlOfertas->BorderStyle = System::Windows::Forms::BorderStyle::FixedSingle;
			this->pnlOfertas->Controls->Add(this->label2);
			this->pnlOfertas->Controls->Add(this->lvwUnits);
			this->pnlOfertas->Location = System::Drawing::Point(333, 434);
			this->pnlOfertas->Name = L"pnlOfertas";
			this->pnlOfertas->Size = System::Drawing::Size(457, 110);
			this->pnlOfertas->TabIndex = 37;
			// 
			// label2
			// 
			...
			this->label2->Text = L"Ofertas por unidades";
			this->label2->TextAlign = System::Drawing::ContentAlignment::MiddleCenter;
			// 
			// lvwUnits
			// 
			this->lvwUnits->Columns->AddRange(gcnew cli::array< System::Windows::Forms::ColumnHeader^  >(2) {this->clhUnit1, this->clhUnit2});
			this->lvwUnits->Font = (gcnew System::Drawing::Font(L"Tahoma", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->lvwUnits->FullRowSelect = true;
			this->lvwUnits->Location = System::Drawing::Point(1, 24);
			this->lvwUnits->Name = L"lvwUnits";
			this->lvwUnits->Size = System::Drawing::Size(206, 78);
			this->lvwUnits->TabIndex = 35;
			this->lvwUnits->UseCompatibleStateImageBehavior = false;
			this->lvwUnits->View = System::Windows::Forms::View::Details;
			// 
			// clhUnit1
			// 
			this->clhUnit1->Text = L"Unidades";
			this->clhUnit1->Width = 80;
			// 
			// clhUnit2
			// 
			this->clhUnit2->Text = L"Precio/Unid.";
			this->clhUnit2->TextAlign = System::Windows::Forms::HorizontalAlignment::Right;
			this->clhUnit2->Width = 100;
			// 
			// pictureBox1
			// 
			this->pictureBox1->Image = (cli::safe_cast<System::Drawing::Image^  >(resources->GetObject(L"pictureBox1.Image")));
			this->pictureBox1->Location = System::Drawing::Point(18, 7);
			...
			this->lbTit->Location = System::Drawing::Point(57, 12);
			this->lbTit->Name = L"lbTit";
			this->lbTit->Size = System::Drawing::Size(313, 23);
			this->lbTit->TabIndex = 33;
			...
			this->l5->Font = (gcnew System::Drawing::Font(L"Tahoma", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->l5->Location = System::Drawing::Point(426, 405);
			this->l5->Name = L"l5";
			...
			this->l4->Font = (gcnew System::Drawing::Font(L"Tahoma", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->l4->Location = System::Drawing::Point(412, 405);
			this->l4->Name = L"l4";
			...
			this->l3->Font = (gcnew System::Drawing::Font(L"Tahoma", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->l3->Location = System::Drawing::Point(398, 405);
			this->l3->Name = L"l3";
			...
			this->l2->Font = (gcnew System::Drawing::Font(L"Tahoma", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->l2->Location = System::Drawing::Point(384, 405);
			this->l2->Name = L"l2";
			...
			this->l1->Font = (gcnew System::Drawing::Font(L"Tahoma", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->l1->Location = System::Drawing::Point(370, 405);
			this->l1->Name = L"l1";
			...
			this->cancelar->Location = System::Drawing::Point(566, 543);
			this->cancelar->Name = L"cancelar";
			this->cancelar->Size = System::Drawing::Size(224, 48);
			this->cancelar->TabIndex = 24;
			this->cancelar->UseVisualStyleBackColor = false;
			this->cancelar->Click += gcnew System::EventHandler(this, &Buscador::Cancelar_Click);
			// 
			// ok
			// 
			...
			this->ok->Location = System::Drawing::Point(333, 543);
			this->ok->Name = L"ok";
			this->ok->Size = System::Drawing::Size(224, 48);
			this->ok->TabIndex = 23;
			this->ok->UseVisualStyleBackColor = false;
			this->ok->Click += gcnew System::EventHandler(this, &Buscador::ok_Click);
			// 
			// pagArriba
			// 
			...
			this->pagArriba->Location = System::Drawing::Point(566, 390);
			this->pagArriba->Name = L"pagArriba";
			this->pagArriba->Size = System::Drawing::Size(50, 48);
			this->pagArriba->TabIndex = 22;
			this->pagArriba->Tag = L"-8";
			this->pagArriba->UseVisualStyleBackColor = false;
			this->pagArriba->Click += gcnew System::EventHandler(this, &Buscador::Paginar_Click);
			// 
			// pagAbajo
			// 
			...
			this->pagAbajo->Location = System::Drawing::Point(719, 390);
			this->pagAbajo->Name = L"pagAbajo";
			this->pagAbajo->Size = System::Drawing::Size(50, 48);
			this->pagAbajo->TabIndex = 21;
			this->pagAbajo->Tag = L"8";
			this->pagAbajo->UseVisualStyleBackColor = false;
			this->pagAbajo->Click += gcnew System::EventHandler(this, &Buscador::Paginar_Click);
			// 
			// filaAbajo
			// 
			...
			this->filaAbajo->Location = System::Drawing::Point(668, 390);
			this->filaAbajo->Name = L"filaAbajo";
			this->filaAbajo->Size = System::Drawing::Size(50, 48);
			this->filaAbajo->TabIndex = 20;
			this->filaAbajo->Tag = L"1";
			this->filaAbajo->UseVisualStyleBackColor = false;
			this->filaAbajo->Click += gcnew System::EventHandler(this, &Buscador::Paginar_Click);
			// 
			// filaArriba
			// 
			...
			this->filaArriba->Location = System::Drawing::Point(617, 390);
			this->filaArriba->Name = L"filaArriba";
			this->filaArriba->Size = System::Drawing::Size(50, 48);
			this->filaArriba->TabIndex = 19;
			this->filaArriba->Tag = L"-1";
			this->filaArriba->UseVisualStyleBackColor = false;
			this->filaArriba->Click += gcnew System::EventHandler(this, &Buscador::Paginar_Click);
			// 
			// b3
			// 
			...
			this->b3->Location = System::Drawing::Point(215, 396);
			this->b3->Name = L"b3";
			this->b3->Size = System::Drawing::Size(50, 48);
			this->b3->TabIndex = 18;
			this->b3->Tag = L"DEF3";
			this->b3->UseVisualStyleBackColor = false;
			this->b3->Click += gcnew System::EventHandler(this, &Buscador::CellButton_Click);
			// 
			// img
			// 
			...
			this->b6->Location = System::Drawing::Point(215, 445);
			this->b6->Name = L"b6";
			this->b6->Size = System::Drawing::Size(50, 48);
			this->b6->TabIndex = 17;
			this->b6->Tag = L"MNO6";
			this->b6->UseVisualStyleBackColor = false;
			this->b6->Click += gcnew System::EventHandler(this, &Buscador::CellButton_Click);
			// 
			// b9
			// 
			...
			this->b9->Location = System::Drawing::Point(215, 494);
			this->b9->Name = L"b9";
			this->b9->Size = System::Drawing::Size(50, 48);
			this->b9->TabIndex = 16;
			this->b9->Tag = L"WXYZ9";
			this->b9->UseVisualStyleBackColor = false;
			this->b9->Click += gcnew System::EventHandler(this, &Buscador::CellButton_Click);
			// 
			// bbksp
			// 
			...
			this->bbksp->Location = System::Drawing::Point(162, 543);
			this->bbksp->Name = L"bbksp";
			this->bbksp->Size = System::Drawing::Size(103, 48);
			this->bbksp->TabIndex = 15;
			this->bbksp->UseVisualStyleBackColor = false;
			this->bbksp->Click += gcnew System::EventHandler(this, &Buscador::bbksp_Click);
			// 
			// b2
			// 
			...
			this->b2->Location = System::Drawing::Point(162, 396);
			this->b2->Name = L"b2";
			this->b2->Size = System::Drawing::Size(50, 48);
			this->b2->TabIndex = 14;
			this->b2->Tag = L"ABC2";
			this->b2->UseVisualStyleBackColor = false;
			this->b2->Click += gcnew System::EventHandler(this, &Buscador::CellButton_Click);
			// 
			// b5
			// 
			...
			this->b5->Location = System::Drawing::Point(162, 445);
			this->b5->Name = L"b5";
			this->b5->Size = System::Drawing::Size(50, 48);
			this->b5->TabIndex = 13;
			this->b5->Tag = L"JKL5";
			this->b5->UseVisualStyleBackColor = false;
			this->b5->Click += gcnew System::EventHandler(this, &Buscador::CellButton_Click);
			// 
			// b8
			// 
			...
			this->b8->Location = System::Drawing::Point(162, 494);
			this->b8->Name = L"b8";
			this->b8->Size = System::Drawing::Size(50, 48);
			this->b8->TabIndex = 12;
			this->b8->Tag = L"TUV8";
			this->b8->UseVisualStyleBackColor = false;
			this->b8->Click += gcnew System::EventHandler(this, &Buscador::CellButton_Click);
			// 
			// b1
			// 
			...
			this->b1->Location = System::Drawing::Point(110, 396);
			this->b1->Name = L"b1";
			this->b1->Size = System::Drawing::Size(50, 48);
			this->b1->TabIndex = 10;
			this->b1->Tag = L"1.-";
			this->b1->UseVisualStyleBackColor = false;
			this->b1->Click += gcnew System::EventHandler(this, &Buscador::CellButton_Click);
			// 
			// b4
			// 
			...
			this->b4->Location = System::Drawing::Point(110, 445);
			this->b4->Name = L"b4";
			this->b4->Size = System::Drawing::Size(50, 48);
			this->b4->TabIndex = 9;
			this->b4->Tag = L"GHI4";
			this->b4->UseVisualStyleBackColor = false;
			this->b4->Click += gcnew System::EventHandler(this, &Buscador::CellButton_Click);
			// 
			// b7
			// 
			...
			this->b7->Location = System::Drawing::Point(110, 494);
			this->b7->Name = L"b7";
			this->b7->Size = System::Drawing::Size(50, 48);
			this->b7->TabIndex = 8;
			this->b7->Tag = L"PQRS7";
			this->b7->UseVisualStyleBackColor = false;
			this->b7->Click += gcnew System::EventHandler(this, &Buscador::CellButton_Click);
			// 
			// b0
			// 
			...
			this->b0->Location = System::Drawing::Point(110, 543);
			this->b0->Name = L"b0";
			this->b0->Size = System::Drawing::Size(50, 48);
			this->b0->TabIndex = 7;
			this->b0->Tag = L" 0";
			this->b0->UseVisualStyleBackColor = false;
			this->b0->Click += gcnew System::EventHandler(this, &Buscador::CellButton_Click);
			// 
			// box
			// 
			...
			this->box->Location = System::Drawing::Point(326, 396);
			this->box->Name = L"box";
			...
			this->kbTimer->Tick += gcnew System::EventHandler(this, &Buscador::kbTimer_Tick);
			// 
			// timerSeek
			// 
			this->timerSeek->Interval = 200;
			this->timerSeek->Tick += gcnew System::EventHandler(this, &Buscador::timerSeek_Tick);
			// 
			// Buscador
			// 
			...
			this->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &Buscador::Buscador_FormClosed);
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->Grid))->EndInit();
			this->panel->ResumeLayout(false);
			this->panel->PerformLayout();
			this->pnlOfertas->ResumeLayout(false);
...
public:
	...
	virtual void AcceptKey(Keys key)
	{
		...
		switch(key)
		{
			...
			default:
				aceptar = false;
				if(completarScanner && !sc_DvEnScanner && sc_DvEnBase && key == Keys::Enter && tbAyuda->Text->Length < 13)
				{
					tbAyuda->Text += "0";
					selIndex = -1;
					Buscar();
				...
				if (this->ActiveOrder == "mplucod" && tbAyuda->Text->Length > 6)
				{
					pulsoEnter = false;
					char unmensaje[100], codingresado[30];
					Strings::StringToChar(tbAyuda->Text, codingresado, 30);
					Alert("El CODIGO ingresado supera los 6 digitos", "Verifique el CODIGO Interno de busqueda.");
					sprintf(unmensaje, "AVISO - En busqueda por Codigo Ingreso = %s", codingresado);
					WriteBootLog(unmensaje);
				}
	...
	System::Void timerSeek_Tick(System::Object^  sender, System::EventArgs^  e) 
	{
		...
		if(Browser != nullptr)
		{
			try
			{
				if(txt != nullptr) Browser->Seek(txt, ActiveOrder);
				if(salt != 0) Browser->Saltear(salt);
				///Agregado
				SetValueLvw();
				CollectValueGarbage();
			}
...
private: 
	...
	System::Void Buscador_Load(System::Object^  sender, System::EventArgs^  e) 
	{
		...
		if(!b1->Visible)
		{
			...
			if (modoMayor)
				this->Grid->Height = this->pnlOfertas->Top - this->Grid->Top - 2;
			else			
				this->Grid->Height = this->pagArriba->Top - this->Grid->Top - 2;			
		}
		lbTit->Text = this->Text;
	}

	System::Void Paginar_Click(System::Object^  sender, System::EventArgs^  e) 
	{
		Button ^boton = (Button ^) sender;
		int offset = int::Parse((String ^) boton->Tag);
		Browser->Saltear(offset);		
	}
	...
	System::Void Buscador_FormClosed(System::Object^  sender, System::Windows::Forms::FormClosedEventArgs^  e) 
	{
...
private: System::Void panel_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
	 ...
	 System::Void SetValueLvw(System::Void)
	 {
		 double lcuni, lcbul;
		 ...
		 if (mostrandolvw)
			 return;
		 mostrandolvw = true;
		 lvwUnits->Items->Clear();
		 //lvwBulto->Items->Clear();

		 DataGridViewRow ^rowsel = this->Grid->CurrentRow;
		 if (modoMayor && rowsel != nullptr && rowsel->Cells->Count > 11)//::Empty)
		 {
			 if (Convert::ToInt16(rowsel->Cells[11]->Value) == 1) //si la PVM = 1, muestra las ofertas
			 {
				 pnlOfertas->Visible = true;
				 ListViewItem ^litemu1 = gcnew ListViewItem();
				 litemu1->Text = Convert::ToDouble(rowsel->Cells[6]->Value).ToString();
				 litemu1->SubItems->Add(rowsel->Cells[7]->Value->ToString());
				 lvwUnits->Items->Add(litemu1);
				 ListViewItem ^litemu2 = gcnew ListViewItem();
				 litemu2->Text = Convert::ToDouble(rowsel->Cells[8]->Value).ToString();
				 litemu2->SubItems->Add(rowsel->Cells[9]->Value->ToString());
				 lvwUnits->Items->Add(litemu2);
				 /*ListViewItem ^litemu3 = gcnew ListViewItem();
				 litemu3->Text = Convert::ToDouble(rowsel->Cells[10]->Value).ToString();
				 litemu3->SubItems->Add(rowsel->Cells[11]->Value->ToString());
				 lvwUnits->Items->Add(litemu3);*/

				 /*lcuni = Convert::ToDouble(rowsel->Cells[18]->Value);
				 ListViewItem ^litemb1 = gcnew ListViewItem();		
				 lcbul = Convert::ToDouble(rowsel->Cells[12]->Value);
				 litemb1->Text = lcbul.ToString();
				 litemb1->SubItems->Add(rowsel->Cells[13]->Value->ToString());
				 litemb1->SubItems->Add((lcuni * lcbul).ToString());
				 lvwBulto->Items->Add(litemb1);
				 ListViewItem ^litemb2 = gcnew ListViewItem();
				 lcbul = Convert::ToDouble(rowsel->Cells[14]->Value);
				 litemb2->Text = lcbul.ToString();
				 litemb2->SubItems->Add(rowsel->Cells[15]->Value->ToString());
				 litemb2->SubItems->Add((lcuni * lcbul).ToString());
				 lvwBulto->Items->Add(litemb2);
				 ListViewItem ^litemb3 = gcnew ListViewItem();	
				 lcbul = Convert::ToDouble(rowsel->Cells[16]->Value);
				 litemb3->Text = lcbul.ToString();
				 litemb3->SubItems->Add(rowsel->Cells[17]->Value->ToString());
				 litemb3->SubItems->Add((lcuni * lcbul).ToString()); 
				 lvwBulto->Items->Add(litemb3);*/
			 }
			 else 
	 ...
	 private: System::Void ClickCelda(System::Object^  sender, System::Windows::Forms::DataGridViewCellEventArgs^  e)
				 {
					 if (!seeking)
					 {
						 SetValueLvw();
